...
var btnForm = document.getElementById('btnform'); //boton de formulario

var codeForm = document.getElementById('codigo');
var nameForm = document.getElementById('nombre'); //nombre

var lastForm = document.getElementById('apellido'); //apellido

var dirForm = document.getElementById('direccion');
var telFom = document.getElementById('telefono');
var resiForm = document.getElementById('residencia');
var oriFrom = document.getElementById('origen');
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = 3;
          return axios.post('http://127.0.0.1:8000/student', obj);
